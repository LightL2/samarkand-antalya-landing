...
window.I18N = {
  ru: {
    ...
    "msg.captchaKey": "Ошибка капчи на «{host}». Обновите вкладку (Ctrl+F5). Открывайте только https://samarkand.asialuxe.uz — без www и без старой вкладки.",
  ...
  uz: {
    ...
    "msg.captchaKey": "«{host}» da kaptcha xatosi. Sahifani yangilang (Ctrl+F5). Faqat https://samarkand.asialuxe.uz dan oching.",
